...
public class ResponseWriter {
     ...
     *
     * @param ok    Flags whether the registration was successful or not
     ...
     *
     * @param ok    Flags whether the log in was successful or not
     * @param cause * 			The cause of failure as string
     * @return response to a request
     */
     ...
     *
     * @param ok    Flags whether the log out was successful or not
     * @param cause * 			The cause of failure as string
     * @return response to a request
     */
     ...
     *
     * @param ipAddress The IP Address of the user to be called
     * @param callID    The call ID as integer
     ...
     *
     * @param ok      Flags whether the request was successful or not
     * @param message The cause of failure as string
     * @return response to a request
     */
     ...
     *
     * @param ok Flags confirmation that the user should end the call
     ...
     *
     * @param usernames An ArrayList of friends of the user
     * @return response containing friend list
     */
    public Response createFriendListResponse(ArrayList<String> usernames) {
        return friendListRes(usernames);
    }
     ...
     *
     * @param username The username of the user that is calling
     * @return response of type call inquiry
     */
    public Response createCallInquiry(String username) {
        return callInquiry(username);
    }
