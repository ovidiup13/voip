...
public class ConnectToDb {
    ...
    public boolean register(String name, String password) {
        ...
        System.out.println("Username already exists in database. Registration of " + name + " unsuccessful.");
        return false;
    }
    ...
    public boolean logIn(String username, String password) {
        try {
            ...
            System.out.println("Error in db while logging in: " + e.getMessage());
            e.printStackTrace();
        } finally {
            closeResultSet(resultSet);
        }
     ...
     *                  The username you want to add as a friend must exist in users table  and check for consistency if the
     ...
     *                  Sets relation status to 1 ( Pending Friend Request)
     *                  calls updateFriends(if both rows exist set status to 2 (Confirm Friend Request)
	...
	*/
     ...
     *
     * @param base password in string format
     */
